...
class UnverifiedTechnicianScreen extends StatefulWidget {
  const UnverifiedTechnicianScreen({super.key});

  @override
  State<UnverifiedTechnicianScreen> createState() =>
      _UnverifiedTechnicianScreenState();
}

class _UnverifiedTechnicianScreenState
    extends State<UnverifiedTechnicianScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PortalMasterLayout(
      body: BlocBuilder<UnverifiedTechnicianCubit, UnverifiedTechnicianState>(
            ...
            success: () {
              _dataSource = TechnicianDataSource(
                listData: List.generate(
                    context
                        .read<UnverifiedTechnicianCubit>()
                        .technicians
                        .length,
                    (index) => context
                        .read<UnverifiedTechnicianCubit>()
                        .technicians[index]),
                verified: false,
                onDetailButtonPressed: (data) => GoRouter.of(context).go(
                    '${RouteUri.unverifiedTechnicianDetail}?id=${data.uid}'),
