...
class UnverifiedTechnicianDetailScreen extends StatefulWidget {
  final String id;

  const UnverifiedTechnicianDetailScreen({
    super.key,
    required this.id,
  });

  @override
  State<UnverifiedTechnicianDetailScreen> createState() =>
      _UnverifiedTechnicianDetailScreenState();
}

class _UnverifiedTechnicianDetailScreenState
    extends State<UnverifiedTechnicianDetailScreen> {
  final _formKey = GlobalKey<FormBuilderState>();

  MapController mapController = MapController();

  void _doVerify(BuildContext context) {
    AppFocusHelper.instance.requestUnfocus();

    final dialog = AwesomeDialog(
      context: context,
      dialogType: DialogType.infoReverse,
      title: 'Apakah Teknisi sudah memenuhi kualifikasi?',
      width: kDialogWidth,
      btnOkText: context.l10n.yes,
      btnOkOnPress: () {
        context.read<UnverifiedTechnicianDetailCubit>().verifyTechnician();
      },
  ...
  Widget build(BuildContext context) {
    ...
    final pageTitle =
        'Unverified Technician - ${widget.id.isEmpty ? context.l10n.crudNew : context.l10n.crudDetail}';

    return PortalMasterLayout(
      selectedMenuUri: RouteUri.unverifiedTechnician,
      body: BlocConsumer<UnverifiedTechnicianDetailCubit,
          UnverifiedTechnicianDetailState>(
            ...
            successDialog: () {
              context
                ...
                ..showSuccessDialog(
                  ...
                  onTap: () {
                    context.go(RouteUri.unverifiedTechnician);
                  },
                );
            },
          );
