...
Electronic _$ElectronicFromJson(Map<String, dynamic> json) {
  return _Electronic.fromJson(json);
}
...
/// @nodoc
@JsonSerializable()
class _$ElectronicImpl extends _Electronic {
  _$ElectronicImpl(
      {this.id,
      this.name,
      this.description,
  ...
  factory _$ElectronicImpl.fromJson(Map<String, dynamic> json) =>
      _$$ElectronicImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$ElectronicImplToJson(
      this,
    );
  }
}

abstract class _Electronic extends Electronic {
  factory _Electronic(
      {final String? id,
      final String? name,
      final String? description,
  ...
  _Electronic._() : super._();

  factory _Electronic.fromJson(Map<String, dynamic> json) =
      _$ElectronicImpl.fromJson;
