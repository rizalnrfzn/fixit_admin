...
_$RepairOrderImpl _$$RepairOrderImplFromJson(Map<String, dynamic> json) =>
    _$RepairOrderImpl(
      ...
      electronic: json['electronic'] == null
          ? null
          : Electronic.fromJson(json['electronic'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$RepairOrderImplToJson(_$RepairOrderImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
