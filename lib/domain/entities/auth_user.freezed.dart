...
class _$AuthUserImpl extends _AuthUser {
  _$AuthUserImpl({this.uid, this.name, this.email, this.profilePicture})
      : super._();
  ...
  @override
  String toString() {
    return 'AuthUser(uid: $uid, name: $name, email: $email, profilePicture: $profilePicture)';
  }
...
abstract class _AuthUser extends AuthUser {
  factory _AuthUser(
      ...
      final String? name,
      final String? email,
      final String? profilePicture}) = _$AuthUserImpl;
  _AuthUser._() : super._();
